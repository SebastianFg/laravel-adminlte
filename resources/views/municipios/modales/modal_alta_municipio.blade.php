      ...
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content col-md-12">
              <div class="modal-header">
                  <h4 class="modal-title" id="myModalLabel">Agregar municipio - localidad</h4>
              </div>
              @if(!$errors->isEmpty())
              ...
              <div class="modal-body ">
                <form action="{{ route('crearMunicipio') }}" class="form-group" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group col-6">
                      <label>Zona</label>
                      <input type="text" name="zona" maxlength="6" autocomplete="off" placeholder="En qué zona se encuentra Ej: Centro" required class="form-control md-2" value="{{ old('zona') }}"> 
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="form-group col-6">
                      ...
                      <input type="text" name="unidad_regional" maxlength="4" autocomplete="off" placeholder="A qué unidad regional pertenece Ej: VII" required class="form-control md-2" value="{{ old('unidad_regional') }}"> 
                    </div>
                  </div>
