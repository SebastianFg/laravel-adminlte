          ...
          <div class="modal-content col-md-12">
              ...
              <div class="modal-body ">
                <form action="{{ route('editarMunicipio') }}" class="form-group" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group col-6">
                      <label>Zona</label>
                      <input type="text" name="zona" id="id_zona_municipio" maxlength="6" autocomplete="off" placeholder="En que zona se encuentra? Ej: Centro" required class="form-control md-2" value="{{ old('zona') }}"> 
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="form-group col-6">
                      ...
                      <input type="text" name="unidad_regional" id="id_ur_municipio" maxlength="4" autocomplete="off" placeholder="A que unidad regional pertenece? Ej: VII" required class="form-control md-2" value="{{ old('unidad_regional') }}"> 
                    </div>
                  </div>
