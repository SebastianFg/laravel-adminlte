        ...
        <form action="{{ route('bajaDefinitiva') }}" class="form-group" method="POST"enctype="multipart/form-data" >
          ...
          <div class="panel-body">
            <div class="form-group col-md-6"  >
                ...
                <input type="text" readonly="" id="dominio_vehiculo" class="form-control" value="Dominio: ">
                <input type="text" readonly="" id="id_vehiculo" hidden  class="form-control"  name="id_vehiculo">
            ...
            <div class="form-group col-md-12">
                ...
                <textarea type="text" name="motivo_de_baja_definitiva" placeholder="Motivo de baja" class="form-control" value="{{ old('observaciones') }}"></textarea>
            </div>
            <div class="form-group col-md-12">
