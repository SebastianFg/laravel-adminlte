...
{{--                 <div class="col-md-3">
          ...
          @extends('vehiculos/modales/modal_alta_vehiculo')
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              @can('vehiculos.eliminar') 
                                <button  onclick="eliminarVehiculo('{{ $item->id_vehiculo }}','{{ $item->numero_de_identificacion }}');" title="Editar vehiculo"  class=" btn btn-danger btn-sm"><i class="fa fa-trash"></i></button>
                              @endcan
                            </td>
