    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content col-md-12">
        ...
        <div class="modal-body col-md-12">
          <form action="{{ route('vehiculos.AsignarRepuesto') }}" class="form-group" method="POST" enctype="multipart/form-data">
            @csrf
...
{{--             <div class="form-group col-md-6">
            ...
            <div class="col-md-12 modal-footer" style="position:relative;">
                <button class="btn btn-success col-md-4 d-inline" type="submit">Guardar</button>
                  <a class="btn btn-danger col-md-4 d-inline" href="{{ route('asignarlistadorepuestos') }}">Cancelar</a>
            </div>
