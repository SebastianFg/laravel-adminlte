    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content col-md-12">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Nuevo tipo vehículo</h4>
            </div>
            @if(!$errors->isEmpty())
              ...
              <form action="{{ route('crearTipoVehiculo') }}" class="form-group" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="form-group col-md-12">
                      <label>Ingrese tipo de vehículo</label>
                      <input type="text" placeholder="Ingrese el tipo de vehículo" name="nombre_tipo_vehiculo" autocomplete="off" class="form-control" >
                  </div>
                </div>
