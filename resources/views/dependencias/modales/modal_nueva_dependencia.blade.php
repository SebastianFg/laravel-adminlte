  ...
  <div class="modal fade" id="miModalDependenciaNueva" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content col-md-12">
            ...
            <div class="modal-body ">
              <form action="{{ route('crearDependencia') }}" class="form-group" method="POST" enctype="multipart/form-data">
                @csrf
