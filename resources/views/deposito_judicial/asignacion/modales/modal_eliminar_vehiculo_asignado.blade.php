      ...
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content col-md-12">
              <div class="modal-header">
                  <h4 class="modal-title" id="myModalLabel">Eliminar asignación DP</h4>
              </div>
              @if(!$errors->isEmpty())
              ...
              <div class="modal-body ">
                <form action="{{ route('eliminarAsignacionDepositoJudicial') }}" class="form-group" method="POST" enctype="multipart/form-data">
