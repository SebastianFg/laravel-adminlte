		...
		<div style="text-align: center;">
			...
			<div class="col-md-12 ">
				<div class="col-md-6" style="display: inline-block; ">
					...
					<p class="pdf_historial" >Número de inventario:<strong class="encabezado_pdf_historial"> {{ $vehiculos_repuestos_asignados[0]->numero_de_inventario_deposito_judicial }} </p>
					<p class="pdf_historial" >Número de identificación:<strong class="encabezado_pdf_historial"> {{ $vehiculos_repuestos_asignados[0]->numero_de_referencia_aleatorio_deposito_judicial}} </p>
				</div>
				<hr>
			</div>
		</div>
