    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content col-md-12">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel">Asignar repuesto DP</h4>
        </div>
        @if(!$errors->isEmpty())
        ...
        <div class="modal-body col-md-12">
          <form action="{{ route('AsignarRepuestoDP') }}" class="form-group" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
