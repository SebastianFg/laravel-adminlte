    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content col-md-12">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel">Editar siniestro DP</h4>
        </div>
        @if(!$errors->isEmpty())
        ...
        <div class="modal-body col-md-12">
          <form  action="{{ route('EditarSiniestroDP') }}"  class="form-group" method="POST" enctype="multipart/form-data">
            @csrf
